...
const ProcessInner = ({
  ...
  return <section className={`process-one ${sectionClass}`}>
...
<img src="/icon/motorbike.png" alt="shape" />
                ...
                <div className="row">
                    {processSteps.map((step, i) => <motion.div initial={{
          y: 80,
          opacity: 0
        }} whileInView={{
          y: 0,
          ...
          amount: 0.01,
          once: true
        }} key={step.id} className={`col-xl-3 col-lg-6 col-md-6 wow `}>
                            <div className="process-one__single">
                                <div className="process-one__single-bg" style={{
              backgroundImage: `url(${step.bg})`
                                ...
                                <div className="process-one__icon-box">
                                    ...
                                    <div className="process-one__icon">
                                        <img src={step.icon} alt="icon" style={{ width: "50px" }} />
                                    </div>
