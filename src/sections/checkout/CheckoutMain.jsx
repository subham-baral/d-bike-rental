...
const CheckoutMain = () => {
  ...
  const orderItems = [{
    id: 1,
    name: "Bolt Sweatshirt",
    price: 88.00
  }, {
    id: 2,
    name: "Cock Kat Kitten Milk X 02",
    price: 188.00
  }];
                                ...
                                <div className="row">
                                    <div className="col-xl-12">
                                        <div className="billing_input_box">
                                            <select className="form-select this-select select-box" aria-label="Sort Options" value={country} onChange={handleCountryChange} required>
                                ...
                                <div className="row">
                                    <div className="col-xl-12">
                                        <div className="form-check check-boxx">
                                            <input className="form-check-input backGround" type="checkbox" checked={accountCheck} onChange={handleAccountCheckChange} id="defaultCheck1" />
                    ...
                    <div className="col-xl-4">
                        <div className="sidebar-order-summary">
                            ...
                            <ul className="sidebar-order-summary__list list-unstyled">
                                {orderItems.map(item => <li key={item.id}>
                                ...
                                <li className='shipping'>
                                    <div className="">
                                        {shippingOptions.map(item => <div key={item.id} className="form-check check-boxx">
                                                <input className="form-check-input backGround" type="checkbox" id={item.id} checked={selected === item.id} onChange={() => handleShippingOptionChange(item.id)} />
                            ...
                            <div className="sidebar-order-summary__Payment">
                                ...
                                <div className="checkout__payment">
                                    <div className={`checkout__payment__item ${isCheckPay === 1 ? 'checkout__payment__item--active' : ''}`}>
                                        ...
                                        <div className="checkout__payment__content" style={{
                    ...
                    display: isCheckPay === 3 ? 'block' : 'none'
                            ...
                            <div className="sidebar-order-summary__bottom">
                                ...
                                <div className="form-check d-flex gap-2 mt-4">
                                    <input className="form-check-input backGround" type="checkbox" id="defaultCheck2" checked={termsAccepted} onChange={handleTermsChange} />
