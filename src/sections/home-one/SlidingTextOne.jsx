...
const slidingTextData = [{
  id: 1,
  text: "Premium",
  icon: "/icon/motorcross.png"
}, {
  id: 2,
  text: "Bikes",
  icon: "/icon/motorcycle-3.png"
}, {
  id: 3,
  text: "Cars",
  icon: "/icon/motorcycle-2.png"
}, {
  id: 4,
  text: "Scooters",
  icon: "/icon/motorbike-2.png"
}, {
  id: 5,
  text: "Buses",
  icon: "/icon/motorcycle-2.png"
                    ...
                    <Marquee speed={60} pauseOnHover={true} direction="left" gradient={false}>
                        {DATAONE.map((item, i) => <span key={i}>
                                <h2 className="sliding-text__title" data-hover={item.text}>
                                    {item.text}
                                    <img src={item?.icon || "/icon/motorcycle.png"} alt="icon" style={{ width: "50px", marginLeft: "20px" }} />
                                </h2>
                            </span>)}
                    </Marquee>
                </ul>
