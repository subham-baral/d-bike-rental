...
<img src="/icon/motorbike.png" alt="shape" />
                    ...
                    <div className="row">
                        {pricingData.map(item => <motion.div initial={{
            y: item?.id % 2 === 0 ? 50 : -50,
            opacity: 0
          }} whileInView={{
            y: 0,
                                ...
                                <div className="pricing-one__single">
                                    ...
                                    <div className="pricing-one__price-and-icon-box">
                                        ...
                                        <div className="pricing-one__icon-box">
                                            <img src={item?.icon || "/icon/motorcycle.png"} alt="icon" style={{ width: "50px" }} />
                                        </div>
                                    </div>
                                    <ul className="list-unstyled pricing-one__points">
                                        {item.points.map((point, index) => <li key={index}>
                                                <div className="text">
                                                    <p>{point.label}</p>
                                                </div>
                                                <div className="price">
...
<img src="/icon/motorbike.png" alt="shape" />
                    ...
                    <div className="popular-car-one__carousel owl-carousel owl-theme">
                        <Swiper modules={[Autoplay]} spaceBetween={30} slidesPerView={5} loop={true} autoplay={{
            delay: 4000,
            ...
            1200: {
              slidesPerView: 5
                            ...
                            {popularCarData.map(item => <SwiperSlide key={item?.id}>
                                    <div className="item">
