...
const TeamOne = () => {
  const [isActiveTab, setIsActiveTab] = React.useState(teamButtonData[0].tabId);
  return <section className="team-one" id='driver'>
                            ...
                            <div className="col-xl-5 col-lg-5">
                                <div className="team-one__tab-buttons-box-one">
                                    <ul className="tab-buttons list-unstyled">
                                        {teamButtonData.map(item => <motion.li initial={{
                    x: -50,
                    opacity: 0
                  }} whileInView={{
                    x: 0,
                            ...
                            <div className="col-xl-7 col-lg-7">
                                <div className="team-one__tabs-content-outer">
                                    <div className="tabs-content">
                                        {teamTabData.map(item => <div key={item?.id} className="tab active-tab" style={{
                    display: `${isActiveTab === `#${item?.tabId}` ? 'block' : 'none'}`
                  }}>
                                                    ...
                                                    <div className="team-one__img-box">
                                                        <div className="team-one__img">
                                                            ...
                                                            <div className="team-one__social">
                                                                {item?.socials.map((social, index) => <Link key={index} href="#">
