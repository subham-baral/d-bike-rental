  ...
  return <section className="booking-one">
            <div className="booking-one__wrap">
              ...
              once: true
                                ...
                                <div className="booking-one__content" style={{ boxShadow: '0 10px 30px rgba(0,0,0,0.2)', padding: '0', overflow: 'visible', backgroundColor: '#fff', borderRadius: '10px' }}>
                                    {/* Title */}
                                    <div className="booking-one__title-box" style={{ padding: '25px 0', margin: '0', borderTopLeftRadius: '10px', borderTopRightRadius: '10px' }}>
