...
const ListingSliders = () => {
  ...
  return <div className="listing-single__inner">
            ...
            disableOnInteraction: false
                            ...
                            {mainSliderData.map(item => <SwiperSlide key={item?.id}>
                                                    ...
                                                    <div className="col-xl-7 col-lg-7">
                                                        <div className="listing-single__right">
                                                            ...
                                                            <ul className="list-unstyled listing-single__meta">
                                                                {item?.lists.map((list, i) => <li key={i + i}>
                                                                            <div className="icon">
            ...
            disableOnInteraction: false
                            ...
                            {thambList.map(item => <SwiperSlide key={item?.id}>
                                        <div className="swiper-slide">
