                ...
                <div className="row">
                    <div className="col-xl-8 col-lg-7">
                        <div className="blog-list__left">
                            {currentBlog.map(blog => <div className="blog-list__single" key={blog?.id}>
                                        ...
                                        <div className="blog-list__content">
                                            ...
                                            <Link href={blog?.link} className="blog-list__read-more">Learn More<span className="icon-arrow-right"></span></Link>
                                        </div>
                                    </div>)}
                    ...
                    e.preventDefault();
                                    ...
                                    {Array.from({
                  length: totalPages
                }).map((_, index) => <li key={index + 8} className={`count ${currentPage === index + 1 ? "active" : ""}`}>
