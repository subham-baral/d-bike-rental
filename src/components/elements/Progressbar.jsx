  ...
  return <li>
            <div className="about-one__progress" ref={ref}>
                ...
                <div className="bar">
                    ...
                    <ProgressBar completed={progress} maxCompleted={100} bgColor="#EE4325" baseBgColor="#E3E3E3" height="10px" isLabelVisible={false} className="progressWrapper" barContainerClassName="barContainer" animateOnRender={false} // disable internal animation
        />
                </div>
            </div>
        </li>;
