...
const ContactThree = () => {
  ...
  return <section className="contact-one" id='contact'>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-8 col-lg-8">
                        ...
                        id: 2,
                        value: "Type Of Service 1",
                        label: "Type Of Service 1"
                      }, {
                        id: 3,
                        value: "Type Of Service 2",
                        label: "Type Of Service 2"
                      }, {
                        id: 4,
                        value: "Type Of Service 3",
                        label: "Type Of Service 3"
                      }, {
                        id: 5,
                        value: "Type Of Service 4",
                        label: "Type Of Service 4"
                      }]} value={service} onChange={value => setService(value)} />
                                            </div>
                                        </div>
                                    </div>
