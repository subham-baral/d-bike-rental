...
const ListingThree = () => {
  ...
  return <section className="listing-three" id='cars'>
          ...
          1024: {
            ...
            spaceBetween: 30
                        ...
                        {listingThreeData.map(item => <SwiperSlide key={item.id}>
                                <div className="item">
