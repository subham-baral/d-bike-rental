...
const CarListVThreeMain = () => {
  ...
  return <section className="car-listing-page-three">
            <div className="container">
                <div className="row">
                    <div className="col-xl-9">
                        <div className="car-listing-page-three__left">
                            <div className="row">
                                {currentCars.map(item => <div className="col-xl-6 col-lg-6 col-md-6" key={item?.id}>
                                            ...
                                            <div className="listing-three__content">
                                                ...
                                                <div className="listing-three__meta-box-info">
                                                    <ul className="list-unstyled listing-three__meta">
                                                        {item.metaOne.map((m, i) => <li key={i + 47}>
                                                                <div className="icon">
                                                    ...
                                                    <ul className="list-unstyled listing-three__meta listing-three__meta--two">
                                                        {item.metaTwo.map((m, i) => <li key={i + 66}>
                                                                <div className="icon">
                                                                    <span className={m.icon}></span>
                                                                </div>
                                                                <div className="text">
