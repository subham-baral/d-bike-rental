...
const BannerOne = () => {
  ...
  return <section className="main-slider" id='home'>
            <div className="main-slider__carousel owl-carousel owl-theme">
                <Swiper modules={[Navigation, Autoplay]} spaceBetween={0} slidesPerView={1} autoplay={{
        delay: 6000,
        disableOnInteraction: false
      }} loop={true} speed={1000} onSlideChange={swiper => setActiveIndex(swiper.realIndex)} onSwiper={setSwiperInstance}>
                    {sliderData.map((item, index) => <SwiperSlide key={item.id}>
                                    ...
                                    <div className="main-slider__content">
                                        ...
                                        <div className="main-slider__btn-and-video-box">
                                            ...
                                            <div className="main-slider__video-link">
                                                <Link href={"#"} onClick={e => handleVideoClick(e, item.videoUrl)} className="video-popup">
