...
const ProductDescription = () => {
  ...
  const renderStars = count => {
    return Array.from({
      length: count
    }, (_, index) => <i key={index} className="icon-star"></i>);
  };
                ...
                <div className="product-details__description">
                    <div className="product-details__main-tab-box tabs-box">
                        <ul className="tab-buttons clearfix list-unstyled">
                            <li onClick={() => setActiveTab(1)} className={`tab-btn ${isActiveTab === 1 ? 'active-btn' : ''}`}>
                                <span>Description</span>
                            </li>
                            <li onClick={() => setActiveTab(2)} className={`tab-btn ${isActiveTab === 2 ? 'active-btn' : ''}`}>
                                <span>Additional information</span>
                            </li>
                            <li onClick={() => setActiveTab(3)} className={`tab-btn ${isActiveTab === 3 ? 'active-btn' : ''}`}>
                                ...
                                <div className="product-details__tab-content-inner">
                                    ...
                                    <div className="review-one">
                                        <div className="comments-area">
                                            ...
                                            {reviews.map(review => <div key={review.id} className="comment-box">
                                    ...
                                    <div className="review-form-one">
                                        <div className="review-form-one__inner">
                                            ...
                                            <form onSubmit={handleSubmitReview} className="review-form-one__form contact-form-validated">
                                                <div className="row">
                                                    <div className="col-xl-12">
                                                        <div className="review-form-one__input-box text-message-box">
                                                            <textarea name="message" placeholder="Write a comment" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row">
