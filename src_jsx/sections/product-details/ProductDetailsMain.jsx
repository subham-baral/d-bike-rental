                    ...
                    <div className="col-lg-6 col-xl-6">
                        <div className="product-details__right">
                            ...
                            <div className="product-details__reveiw">
                                {[...Array(5)].map((_, index) => <i key={index} className="icon-star"></i>)}
                                ...
                                <div className="product-details__select-size">
                                    ...
                                    <ul className="list-unstyled">
                                        {sizes.map((size, index) => <li key={size}>
                                                <input type="radio" id={`size${index + 1}`} name="size" value={size} checked={selectedSize === size} onChange={() => handleSizeChange(size)} />
                            ...
                            <div className="product-details__inner">
                                ...
                                <div className="product-details__buttons-boxes">
                                    <div className="product-details__buttons-1">
                                        <button onClick={handleAddToWishlist} className="thm-btn" type="button">
                                            Add to Wishlist
                                            <span>
                                    ...
                                    <div className="product-details__buttons-2">
                                        <button onClick={handleAddToCart} className="thm-btn" type="button">
                                            Add to Cart
                                            <span>
                                                <i className="icon-diagonal-arrow"></i>
                                            </span>
