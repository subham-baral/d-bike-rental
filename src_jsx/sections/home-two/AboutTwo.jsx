...
const AboutTwo = () => {
  ...
  return <section className="about-two" id='about'>
            <div className="container">
                <div className="row">
                            ...
                            <div className="about-two__progress-box">
                                ...
                                <div className="about-two__progress-single">
                                    <div className="graph-outer">
                                        ...
                                        <div className="inner-text count-box"><span className="count-text" data-stop="98" data-speed="2000"></span><span className="count-Parsent"><span className='fontSize'><AdvanceCountUp ending={98} /></span> %</span>
                                        </div>
                                    </div>
                                    <div className="about-two__progress-text-box">
                                        <h4>Success Rate</h4>
                    ...
                    <div className="col-xl-6">
                        <div className="about-two__right wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
