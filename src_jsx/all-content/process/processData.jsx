...
export const processSteps = [{
  id: 1,
  title: "Choose A Car",
  description: "Open multiply a green form lesser their from in made herb multiply",
  icon: "icon-car-wash",
  bg: processBg1
}, {
  id: 2,
...
// Data
export const pricingPlansThree = [{
  id: 1,
  title: 'Basic',
  price: 500,
  image: pricingImg1,
  features: ['Car service is essential for maintaining.', 'Performance and longevity of vehicle.', 'Per minutes stopped traffic', 'Online booking', '24/7 customer support']
}, {
  id: 2,
  title: 'Standard',
  price: 600,
