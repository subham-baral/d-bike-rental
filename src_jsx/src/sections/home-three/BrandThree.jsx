...
const BrandThree = () => {
    return (_jsx("section", { className: "brand-one brand-three", children: _jsx("div", { className: "container", children: _jsx("div", { className: "brand-one__carousel owl-theme  ", children: _jsx(Swiper, { modules: [Autoplay], spaceBetween: 30, slidesPerView: 6, loop: true, autoplay: {
                        delay: 4000,
