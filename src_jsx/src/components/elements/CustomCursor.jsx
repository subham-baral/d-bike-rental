...
const CustomCursor = ({ enabled = true, ignoreReducedMotion = false, }) => {
    ...
    useEffect(() => {
        ...
        const prefersReduced = !ignoreReducedMotion &&
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { ref: cursorRef, className: "custom-cursor__cursor" }), _jsx("div", { ref: innerRef, className: "custom-cursor__cursor-two" })] }));
};
